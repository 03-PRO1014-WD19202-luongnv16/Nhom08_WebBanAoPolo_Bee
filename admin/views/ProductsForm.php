                        ...
                        <div class="panel-body">
                            <form method="POST" enctype="multipart/form-data" action="<?php echo $action; ?>">
                                <div class="form-group">
                                    ...
                                    <input required="true" type="text" class="form-control" id="title" name="title"  value="<?php echo isset($record->title)?$record->title:""; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required="true" type="text" class="form-control" id="price" name="price"  value="<?php echo isset($record->price)?$record->price:""; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="name">Số Lượng Sản Phẩm:</label>
                                    <input required="true" type="number" class="form-control" id="number" name="number"  value="<?php echo isset($record->number)?$record->number:""; ?>">
                                </div>
                                <div class="form-group">
                                    <!-- <label for="exampleFormControlFile1">Thumbnail:<label> -->
                                    <label for="name">Thumbnail:</label>
                                    <input type="file" class="form-control-file" id="exampleFormControlFile1" id="thumbnail" name="thumbnail" value="<?php echo isset($record->thumbnail)?$record->thumbnail:""; ?>">
                                    <img src="<?= $thumbnail ?>" style="max-width: 200px" id="img_thumbnail">
                                </div>
                                <div class="form-group">
                                    <!-- <label for="exampleFormControlFile1">Thumbnail:<label> -->
                                    <label for="name">Thumbnail:</label>
                                    <input type="file" class="form-control-file" id="exampleFormControlFile1" id="thumbnail_1" name="thumbnail_1" value="<?php echo isset($record->thumbnail_1)?$record->thumbnail_1:""; ?>">
                                    <img src="<?= $thumbnail_1 ?>" style="max-width: 200px" id="img_thumbnail_1">
                                </div>
                                <div class="form-group">
                                    <!-- <label for="exampleFormControlFile1">Thumbnail:<label> -->
                                    <label for="name">Thumbnail:</label>
                                    <input type="file" class="form-control-file" id="exampleFormControlFile1" id="thumbnail_2" name="thumbnail_2" value="<?php echo isset($record->thumbnail_2)?$record->thumbnail_2:""; ?>">
                                    <img src="<?= $thumbnail_2 ?>" style="max-width: 200px" id="img_thumbnail_2">
                                </div>
                                <div class="form-group">
                                    <!-- <label for="exampleFormControlFile1">Thumbnail:<label> -->
                                    <label for="name">Thumbnail:</label>
                                    <input type="file" class="form-control-file" id="exampleFormControlFile1" id="thumbnail_3" name="thumbnail_3" value="<?php echo isset($record->thumbnail_3)?$record->thumbnail_3:""; ?>">
                                    <img src="<?= $thumbnail_3 ?>" style="max-width: 200px" id="img_thumbnail_3">
                                </div>
                                <div class="form-group">
                                    <!-- <label for="exampleFormControlFile1">Thumbnail:<label> -->
                                    <label for="name">Thumbnail:</label>
                                    <input type="file" class="form-control-file" id="exampleFormControlFile1" id="thumbnail_4" name="thumbnail_4" value="<?php echo isset($record->thumbnail_4)?$record->thumbnail_4:""; ?>">
                                    <img src="<?= $thumbnail_4 ?>" style="max-width: 200px" id="img_thumbnail_4">
                                </div>
                                <div class="form-group">
                                    <!-- <label for="exampleFormControlFile1">Thumbnail:<label> -->
                                    <label for="name">Thumbnail:</label>
                                    <input type="file" class="form-control-file" id="exampleFormControlFile1" id="thumbnail_5" name="thumbnail_5" value="<?php echo isset($record->thumbnail_5)?$record->thumbnail_5:""; ?>">
                                    <img src="<?= $thumbnail_5 ?>" style="max-width: 200px" id="img_thumbnail_5">
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1">Nội dung</label>
                                    <textarea class="form-control" id="content" rows="3" name="content"><?= isset($record->content)?$record->content:""; ?></textarea>
                                </div>
                                <hr class="navbar-divider my-3 opacity-20">
