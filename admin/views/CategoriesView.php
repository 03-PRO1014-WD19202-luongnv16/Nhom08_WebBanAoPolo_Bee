            ...
            <div class="container-fluid">
                ...
                <div class="card shadow border-0 mb-7">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="index.php?controller=categories&action=create" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                    <span class=" pe-2">
                                ...
                                <tr>
                                    <?php
                                        ...
                                        foreach ($data as $key => $item): ?>
                                            ...
                                            <td>
                                            <a href="index.php?controller=categories&action=delete&id=<?= $item->id ?>" onclick="return window.confirm('Are you sure?');">
