                                    ...
                                    <form method="POST" enctype="multipart/form-data" action="<?php echo $action; ?>">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="id_user" name="id_user"
                                                value="<?php echo isset($record->id_user) ? $record->id_user : ""; ?>"
                                                hidden="true">
                                            <input required="true" type="text" class="form-control" id="fullname"
                                                name="fullname"
                                                value="<?php echo isset($record->fullname) ? $record->fullname : ""; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Tên Đăng Nhập:</label>
                                            <input required="true" type="text" class="form-control" id="tendangnhap"
                                                name="tendangnhap"
                                                value="<?php echo isset($record->tendangnhap) ? $record->tendangnhap : ""; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Email:</label>
                                            <input required="true" type="text" class="form-control" id="email"
                                                name="email"
                                                value="<?php echo isset($record->email) ? $record->email : ""; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Địa Chỉ:</label>
                                            <input required="true" type="text" class="form-control" id="diachi"
                                                name="diachi"
                                                value="<?php echo isset($record->diachi) ? $record->diachi : ""; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Mật Khẩu:</label>
                                            <input required="true" type="text" class="form-control" id="matkhau"
                                                name="matkhau"
                                                value="<?php echo isset($record->matkhau) ? $record->matkhau : ""; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Số Điện Thoại:</label>
                                            <input required="true" type="text" class="form-control" id="dienthoai"
                                                name="dienthoai"
                                                value="<?php echo isset($record->dienthoai) ? $record->dienthoai : ""; ?>">
                                        </div>
                                        <hr class="navbar-divider my-3 opacity-20">
