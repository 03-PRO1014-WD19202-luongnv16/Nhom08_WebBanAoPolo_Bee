            ...
            <div class="container-fluid">
                ...
                <div class="card shadow border-0 mb-7">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="index.php?controller=users&action=create" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                    <span class=" pe-2">
                                       ...
                                       echo 'Bạn đang ở trang: ' . $pg;
                                            foreach ($data as $index => $item): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="index.php?controller=users&action=update&id=<?= $item->id_user ?>">
                                                            <button class=" btn btn-warning">Sửa</button>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="index.php?controller=users&action=delete&id=<?= $item->id_user ?>"  onclick="return window.confirm('Bạn có chắc chắn muốn xoá User này không?');"  >
                        ...
                        <nav aria-label="Page navigation example">
                          ...
                          <?php
                            ...
                            for ($i = 1; $i <= $numPage; $i++) {
                                ...
                                if ($i == $numPage) {
                                    echo '
                            <li class="page-item"><a class="page-link" href="index.php?controller=users&page=' . $i . '">' . $i . '</a></li>';
                                } else {
                                    echo '
                            <li class="page-item"><a class="page-link" href="index.php?controller=users&page=' . $i . '">' . $i . '</a></li>
                                    ';
