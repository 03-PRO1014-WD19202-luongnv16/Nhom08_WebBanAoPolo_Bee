            ...
            <div class="container-fluid">
                ...
                <div class="card shadow border-0 mb-7">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="index.php?controller=products&action=create" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                    <span class=" pe-2">
                                        ...
                                        foreach ($data as $key => $item) :?>
                                            <tr>
                                                ...
                                                <td style="text-align:center">
                                                    <img src="../assets/images/<?= $item->thumbnail ?>" alt="" class="avatar avatar-sm rounded-circle me-2">
                                                </td>
                                                ...
                                                <td>
                                                    <a href="index.php?controller=products&action=update&id=<?php echo $item->id; ?>">
                                                        <button class=" btn btn-warning">Sửa</button>
                                                    </a>
                                                </td>
                                                <td>
                                                <a href="index.php?controller=products&action=delete&id=<?php echo $item->id; ?>" onclick="return window.confirm('Bạn có chắc chắn muốn xoá sản phẩm này không?');">
