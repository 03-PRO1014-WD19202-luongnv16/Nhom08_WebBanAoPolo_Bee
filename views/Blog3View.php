...
<ul id="list-new">
    <div class="item"><!--sản phẩm 2 -->
        <img src="assets/images/Blog/Blog_3/new2.jpg"width="345" height="345"  alt="">
    ...
    <div class="item"><!--sản phẩm 1 -->
        <img src="assets/images/Blog/Blog_3/new1.jpg"width="345" height="345"  alt="">
